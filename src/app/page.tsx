  ...
  return (
    <main className="atlas-page" id="top" style={pageStyle}>
      <header className="atlas-header">
        ...
        <nav className="atlas-desktop-nav" aria-label="Primary navigation"><a href="#atlas">Water atlas</a><a href="#harvest">Rainwater</a><a href="#sources">Resources</a><a href="#context">Sector context</a></nav>
        <div className="atlas-header-actions"><button type="button" aria-label="Search"><Search size={20} /></button><a href="#community"><Plus size={17} />Report a source</a><div className={`atlas-mobile-nav${mobileMenuOpen ? " is-open" : ""}`}><button type="button" aria-label="Open navigation" aria-expanded={mobileMenuOpen} onClick={() => setMobileMenuOpen((open) => !open)}><Menu size={21} /></button><nav aria-label="Mobile navigation"><a href="#atlas" onClick={() => setMobileMenuOpen(false)}>Water atlas</a><a href="#harvest" onClick={() => setMobileMenuOpen(false)}>Rainwater potential</a><a href="#sources" onClick={() => setMobileMenuOpen(false)}>Resources</a><a href="#context" onClick={() => setMobileMenuOpen(false)}>Sector context</a><a href="#community" onClick={() => setMobileMenuOpen(false)}>Report a source</a></nav></div></div>
      </header>
      ...
      <section className="resources-section" id="sources" aria-labelledby="resources-title">
        <div className="resources-heading">
          <p>Trusted references</p>
          <h2 id="resources-title">Resources</h2>
          <span>Explore the official surveys and national strategy behind AquaLeb’s water indicators.</span>
        </div>
      ...
      <footer className="aqualeb-footer" id="community">
        <div className="footer-main">
          ...
          <div className="footer-column"><strong>Explore</strong><a href="#atlas">Water atlas</a><a href="#harvest">Rainwater potential</a><a href="#sources">Resources</a></div>

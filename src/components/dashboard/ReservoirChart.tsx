      ...
      <div className="chart-wrap">
        <ResponsiveContainer width="100%" height="100%">
          <AreaChart data={data} margin={{ top: 8, right: 4, left: -28, bottom: 0 }}>
            <defs><linearGradient id="waterFill" x1="0" y1="0" x2="0" y2="1"><stop offset="0%" stopColor="#6696aa" stopOpacity={0.28} /><stop offset="100%" stopColor="#6696aa" stopOpacity={0.02} /></linearGradient></defs>
            ...
            <Area type="monotone" dataKey="level" stroke="#205b7a" strokeWidth={2.5} fill="url(#waterFill)" dot={{ r: 2.5, fill: "#205b7a", strokeWidth: 0 }} activeDot={{ r: 5 }} />
          </AreaChart>
        </ResponsiveContainer>
      </div>
